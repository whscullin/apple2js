...
type Flag = 0b00000001 | 0b00000010 | 0b00000100 | 0b00001000 |
    0b00010000 | 0b00100000 | 0b01000000 | 0b10000000;

type FlagName = "N" | "V" | "B" | "D" | "I" | "Z" | "C";

/** Flags to status byte mask. */
const FLAGS: Record<FlagName, Flag> = {
    N: 0x80, // Negative
    V: 0x40, // oVerflow
    B: 0x10, // Break
    D: 0x08, // Decimal
...
export default class CPU6502 {
    ...
    /* Load X Register */
    ldx(val: byte) {
        this.xr = this.testNZ(val);
    }

    /* Load Y Register */
    ldy(val: byte) {
        this.yr = this.testNZ(val);
    }
    ...
    /* Add with Carry */
    adc(val: byte) {
        this.ar = this.add(this.ar, val, /* sub= */ false);
    }

    /* Subtract with Carry */
    sbc(val: byte) {
        this.ar = this.add(this.ar, val, /* sub= */ true);
    }
    ...
    cpx(val: byte) {
        this.compare(this.xr, val);
    }

    cpy(val: byte) {
        this.compare(this.yr, val);
    }
    ...
    public step(cb: callback) {
        this.sync = true;
        let instruction = this.readBytePC();
        this.sync = false;
        this.op(instruction);
    ...
    private op(instruction: byte) {
        switch (instruction) {
            // LDA
            case 0xa9: this.lda(this.readImmediate()); break;
            case 0xa5: this.lda(this.readZeroPage()); break;
            case 0xb5: this.lda(this.readZeroPageX()); break;
            case 0xad: this.lda(this.readAbsolute()); break;
            case 0xbd: this.lda(this.readAbsoluteX()); break;
            case 0xb9: this.lda(this.readAbsoluteY()); break;
            case 0xa1: this.lda(this.readZeroPageXIndirect()); break;
            case 0xb1: this.lda(this.readZeroPageIndirectY()); break;

            // LDX
            case 0xa2: this.ldx(this.readImmediate()); break;
            case 0xa6: this.ldx(this.readZeroPage()); break;
            case 0xb6: this.ldx(this.readZeroPageY()); break;
            case 0xae: this.ldx(this.readAbsolute()); break;
            case 0xbe: this.ldx(this.readAbsoluteY()); break;

            // LDY
            case 0xa0: this.ldy(this.readImmediate()); break;
            case 0xa4: this.ldy(this.readZeroPage()); break;
            case 0xb4: this.ldy(this.readZeroPageX()); break;
            case 0xac: this.ldy(this.readAbsolute()); break;
            case 0xbc: this.ldy(this.readAbsoluteX()); break;

            // STA
            case 0x85: this.writeZeroPage(this.sta()); break;
            case 0x95: this.writeZeroPageX(this.sta()); break;
            case 0x8d: this.writeAbsolute(this.sta()); break;
            case 0x9d: this.writeAbsoluteX(this.sta()); break;
            case 0x99: this.writeAbsoluteY(this.sta()); break;
            case 0x81: this.writeZeroPageXIndirect(this.sta()); break;
            case 0x91: this.writeZeroPageIndirectY(this.sta()); break;

            // STX
            case 0x86: this.writeZeroPage(this.stx()); break;
            case 0x96: this.writeZeroPageY(this.stx()); break;
            case 0x8e: this.writeAbsolute(this.stx()); break;

            // STY
            case 0x84: this.writeZeroPage(this.sty()); break;
            case 0x94: this.writeZeroPageX(this.sty()); break;
            case 0x8c: this.writeAbsolute(this.sty()); break;

            // ADC
            case 0x69: this.adc(this.readImmediate()); break;
            case 0x65: this.adc(this.readZeroPage()); break;
            case 0x75: this.adc(this.readZeroPageX()); break;
            case 0x6D: this.adc(this.readAbsolute()); break;
            case 0x7D: this.adc(this.readAbsoluteX()); break;
            case 0x79: this.adc(this.readAbsoluteY()); break;
            case 0x61: this.adc(this.readZeroPageXIndirect()); break;
            case 0x71: this.adc(this.readZeroPageIndirectY()); break;

            // SBC
            case 0xe9: this.sbc(this.readImmediate()); break;
            case 0xe5: this.sbc(this.readZeroPage()); break;
            case 0xf5: this.sbc(this.readZeroPageX()); break;
            case 0xeD: this.sbc(this.readAbsolute()); break;
            case 0xfD: this.sbc(this.readAbsoluteX()); break;
            case 0xf9: this.sbc(this.readAbsoluteY()); break;
            case 0xe1: this.sbc(this.readZeroPageXIndirect()); break;
            case 0xf1: this.sbc(this.readZeroPageIndirectY()); break;

            // INC
            case 0xe6: this.inc(this.readAddrZeroPage()); break;
            case 0xf6: this.inc(this.readAddrZeroPageX()); break;
            case 0xee: this.inc(this.readAddrAbsolute()); break;
            case 0xfe: this.inc(this.readAddrAbsoluteX()); break;
            ...
            // DEC
            case 0xc6: this.dec(this.readAddrZeroPage()); break;
            case 0xd6: this.dec(this.readAddrZeroPageX()); break;
            case 0xce: this.dec(this.readAddrAbsolute()); break;
            case 0xde: this.dec(this.readAddrAbsoluteX()); break;
            ...
            case 0x06: this.asl(this.readAddrZeroPage()); break;
            case 0x16: this.asl(this.readAddrZeroPageX()); break;
            case 0x0E: this.asl(this.readAddrAbsolute()); break;
            case 0x1E: this.asl(this.readAddrAbsoluteX()); break;

            // LSR
            case 0x4A: this.lsrA(); break;
            case 0x46: this.lsr(this.readAddrZeroPage()); break;
            case 0x56: this.lsr(this.readAddrZeroPageX()); break;
            case 0x4E: this.lsr(this.readAddrAbsolute()); break;
            case 0x5E: this.lsr(this.readAddrAbsoluteX()); break;

            // ROL
            case 0x2A: this.rolA(); break;
            case 0x26: this.rol(this.readAddrZeroPage()); break;
            case 0x36: this.rol(this.readAddrZeroPageX()); break;
            case 0x2E: this.rol(this.readAddrAbsolute()); break;
            case 0x3E: this.rol(this.readAddrAbsoluteX()); break;

            // ROR
            case 0x6A: this.rorA(); break;
            case 0x66: this.ror(this.readAddrZeroPage()); break;
            case 0x76: this.ror(this.readAddrZeroPageX()); break;
            case 0x6E: this.ror(this.readAddrAbsolute()); break;
            case 0x7E: this.ror(this.readAddrAbsoluteX()); break;

            // AND
            case 0x29: this.and(this.readImmediate()); break;
            case 0x25: this.and(this.readZeroPage()); break;
            case 0x35: this.and(this.readZeroPageX()); break;
            case 0x2D: this.and(this.readAbsolute()); break;
            case 0x3D: this.and(this.readAbsoluteX()); break;
            case 0x39: this.and(this.readAbsoluteY()); break;
            case 0x21: this.and(this.readZeroPageXIndirect()); break;
            case 0x31: this.and(this.readZeroPageIndirectY()); break;

            // ORA
            case 0x09: this.ora(this.readImmediate()); break;
            case 0x05: this.ora(this.readZeroPage()); break;
            case 0x15: this.ora(this.readZeroPageX()); break;
            case 0x0D: this.ora(this.readAbsolute()); break;
            case 0x1D: this.ora(this.readAbsoluteX()); break;
            case 0x19: this.ora(this.readAbsoluteY()); break;
            case 0x01: this.ora(this.readZeroPageXIndirect()); break;
            case 0x11: this.ora(this.readZeroPageIndirectY()); break;

            // EOR
            case 0x49: this.eor(this.readImmediate()); break;
            case 0x45: this.eor(this.readZeroPage()); break;
            case 0x55: this.eor(this.readZeroPageX()); break;
            case 0x4D: this.eor(this.readAbsolute()); break;
            case 0x5D: this.eor(this.readAbsoluteX()); break;
            case 0x59: this.eor(this.readAbsoluteY()); break;
            case 0x41: this.eor(this.readZeroPageXIndirect()); break;
            case 0x51: this.eor(this.readZeroPageIndirectY()); break;

            // CMP
            case 0xc9: this.cmp(this.readImmediate()); break;
            case 0xc5: this.cmp(this.readZeroPage()); break;
            case 0xd5: this.cmp(this.readZeroPageX()); break;
            case 0xcD: this.cmp(this.readAbsolute()); break;
            case 0xdD: this.cmp(this.readAbsoluteX()); break;
            case 0xd9: this.cmp(this.readAbsoluteY()); break;
            case 0xc1: this.cmp(this.readZeroPageXIndirect()); break;
            case 0xd1: this.cmp(this.readZeroPageIndirectY()); break;

            // CPX
            case 0xE0: this.cpx(this.readImmediate()); break;
            case 0xE4: this.cpx(this.readZeroPage()); break;
            case 0xEC: this.cpx(this.readAbsolute()); break;

            // CPY
            case 0xC0: this.cpy(this.readImmediate()); break;
            case 0xC4: this.cpy(this.readZeroPage()); break;
            case 0xCC: this.cpy(this.readAbsolute()); break;

            // BIT
            case 0x24: this.bit(this.readZeroPage()); break;
            case 0x2C: this.bit(this.readAbsolute()); break;

            // BCC
            case 0x90: this.brc(FLAGS.C); break;

            // BCS
            case 0xB0: this.brs(FLAGS.C); break;

            // BEQ
            case 0xF0: this.brs(FLAGS.Z); break;

            // BMI
            case 0x30: this.brs(FLAGS.N); break;

            // BNE
            case 0xD0: this.brc(FLAGS.Z); break;

            // BPL
            case 0x10: this.brc(FLAGS.N); break;

            // BVC
            case 0x50: this.brc(FLAGS.V); break;

            // BVS
            case 0x70: this.brs(FLAGS.V); break;
            ...
            // JMP
            case 0x4C: this.jmp(this.readAddrAbsolute()); break;
            case 0x6C: this.jmp(this.readAddrAbsoluteIndirectBug()); break;
            ...
            // SEC
            case 0x38: this.set(FLAGS.C); break;

            // SED
            case 0xF8: this.set(FLAGS.D); break;

            // SEI
            case 0x78: this.set(FLAGS.I); break;

            // CLC
            case 0x18: this.clr(FLAGS.C); break;

            // CLD
            case 0xD8: this.clr(FLAGS.D); break;

            // CLI
            case 0x58: this.clr(FLAGS.I); break;

            // CLV
            case 0xB8: this.clr(FLAGS.V); break;

            // NOP
            case 0xea: this.nop(); break;

            // BRK
            case 0x00: this.brk(this.readImmediate()); break;

            // Unkown instructions
            default: this.nop(); break;
        }
    }
};
