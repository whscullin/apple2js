...
export default function SmartPort(io, cpu) {
    ...
    */
    ...
    var ROM = [
        ...
        0x0a,0xa5,0x01,0xcd,0xf8,0x07,0xd0,0x03, // 0x20
        0x4c,0xba,0xfa,0x4c,0x00,0xe0,0xa2,0x01, //
        0x86,0x42,0xca,0x86,0x46,0x86,0x47,0x86, // 0x30
        0x44,0xa2,0x08,0x86,0x45,0xad,0xf8,0x07, //
        0x48,0x48,0xa9,0x47,0x48,0xb8,0x50,0x0b, // 0x40
        0x68,0x0a,0x0a,0x0a,0x0a,0xaa,0x4c,0x01, //
        0x08,0x00,0x00,0x60,0x00,0x00,0x60,0x00, //
...
*/
    ...
    return {
        ...
        read: function(page, off) {
            ...
            if (off == 0x53 && cpu.sync()) { // Regular block device entry POINT
